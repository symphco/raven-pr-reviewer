...
export const COMMENT_GREETING = ':robot: Raven'

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by Raven (AI) -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by Raven -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by Raven (AI) -->'

export const DESCRIPTION_START_TAG = `
<!-- This is an auto-generated comment: release notes by Raven (AI) -->`
export const DESCRIPTION_END_TAG =
  '<!-- end of auto-generated comment: release notes by Raven (AI) -->'

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by Raven (AI) -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by Raven (AI) -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by Raven (AI) -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by Raven (AI) -->`
